...
function init() {
    ...
    loader.load('models/yinshuashu.glb', (loadedGltf) => {
        // 自动居中模型
        ...
        loadedGltf.scene.traverse((object) => {
            if (object.isMesh) {
                // 设置木质颜色
                object.material.color.setHex(0x5E3C23); // 深胡桃木色
                // 添加木质纹理特征
                object.material.emissive.setHex(0x1A0F0A); // 暗红色环境反射
                // 调整材质物理属性
                object.material.metalness = 0.1;    // 低金属感
                object.material.roughness = 0.8;    // 高表面粗糙度
                // 可选：如果需要木纹效果可以添加纹理贴图
